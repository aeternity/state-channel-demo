...
* Node:
  ...
  * Runs complex logic in the Finite State Machine (FSM) process which is required to execute off-chain transactions by communicating to clients and other nodes.
